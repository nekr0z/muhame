...
type MetricsServiceClient interface {
	Update(ctx context.Context, in *MetricRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	BulkUpdate(ctx context.Context, in *BulkRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *metricsServiceClient) Update(ctx context.Context, in *MetricRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *metricsServiceClient) BulkUpdate(ctx context.Context, in *BulkRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MetricsService_BulkUpdate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetricsServiceServer interface {
	Update(context.Context, *MetricRequest) (*emptypb.Empty, error)
	BulkUpdate(context.Context, *BulkRequest) (*emptypb.Empty, error)
...
func (UnimplementedMetricsServiceServer) Update(context.Context, *MetricRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedMetricsServiceServer) BulkUpdate(context.Context, *BulkRequest) (*emptypb.Empty, error) {
...
func _MetricsService_BulkUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServiceServer).BulkUpdate(ctx, req.(*BulkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
